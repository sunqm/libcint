...
int main()
{
        ...
        i = 0; shls[0] = i; di = CINTcgtos_spheric(i, bas);
        j = 1; shls[1] = j; dj = CINTcgtos_spheric(j, bas);
        ...
        i = 0; shls[0] = i; di = CINTcgtos_spheric(i, bas);
        j = 1; shls[1] = j; dj = CINTcgtos_spheric(j, bas);
        k = 2; shls[2] = k; dk = CINTcgtos_spheric(k, bas);
        l = 2; shls[3] = l; dl = CINTcgtos_spheric(l, bas);
