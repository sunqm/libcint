...
int cint1e_iking_sph(double *opij, const int *shls,
const int *atm, const int natm,
const int *bas, const int nbas, const double *env) {
const int i_sh = shls[0];
const int j_sh = shls[1];
...
gout1e_cint1e_iking_sph, &c2s_sph_1e,
shls, atm, natm, bas, nbas, env); }
C2F_(cint1e_iking_sph)
/* <i|OVLP |G j> */
static void gout1e_cint1e_iovlpg_sph(double *g, const int *ng,
double *gout, const int nf, const int *idx,
const double ai, const double aj,
const int *shls, const int *atm, const int *bas, const double *env) {
const int INC1 = 1;
...
int cint1e_iovlpg_sph(double *opij, const int *shls,
const int *atm, const int natm,
const int *bas, const int nbas, const double *env) {
const int i_sh = shls[0];
const int j_sh = shls[1];
...
return 0; }
return cint1e_drv(opij, ng, 0.5,
gout1e_cint1e_iovlpg_sph, &c2s_sph_1e,
shls, atm, natm, bas, nbas, env); }
C2F_(cint1e_iovlpg_sph)
/* <i|NUC |G j> */
static void gout1e_cint1e_inucg_sph(double *g, const int *ng,
double *gout, const int nf, const int *idx,
const double ai, const double aj,
const int *shls, const int *atm, const int *bas, const double *env) {
const int INC1 = 1;
...
int cint1e_inucg_sph(double *opij, const int *shls,
const int *atm, const int natm,
const int *bas, const int nbas, const double *env) {
const int i_sh = shls[0];
const int j_sh = shls[1];
...
gout1e_cint1e_inucg_sph, &c2s_sph_1e,
shls, atm, natm, bas, nbas, env); }
C2F_(cint1e_inucg_sph)
