...
gout[n*16+1] = - s[6] + s[0];
gout[n*16+2] = + s[3] - s[0];
gout[n*16+3] = + s[0] + s[3] + s[6];
gout[n*16+4] = + s[7] - s[4];
gout[n*16+5] = - s[7] + s[1];
gout[n*16+6] = + s[4] - s[1];
gout[n*16+7] = + s[1] + s[4] + s[7];
gout[n*16+8] = + s[8] - s[5];
gout[n*16+9] = - s[8] + s[2];
gout[n*16+10] = + s[5] - s[2];
gout[n*16+11] = + s[2] + s[5] + s[8];
gout[n*16+12] = 0;
gout[n*16+13] = 0;
gout[n*16+14] = 0;
gout[n*16+15] = 0;
...
gout[n*48+9] = - s[5];
gout[n*48+10] = - s[8];
gout[n*48+11] = + s[8] - s[5];
gout[n*48+12] = 0;
gout[n*48+13] = 0;
gout[n*48+14] = 0;
gout[n*48+15] = 0;
gout[n*48+16] = - s[0];
gout[n*48+17] = + s[0] + s[6];
gout[n*48+18] = - s[6];
gout[n*48+19] = - s[6] + s[0];
gout[n*48+20] = - s[1];
gout[n*48+21] = + s[1] + s[7];
gout[n*48+22] = - s[7];
gout[n*48+23] = - s[7] + s[1];
gout[n*48+24] = - s[2];
gout[n*48+25] = + s[2] + s[8];
gout[n*48+26] = - s[8];
gout[n*48+27] = - s[8] + s[2];
gout[n*48+28] = 0;
gout[n*48+29] = 0;
gout[n*48+30] = 0;
gout[n*48+31] = 0;
gout[n*48+32] = - s[0];
gout[n*48+33] = - s[3];
gout[n*48+34] = + s[0] + s[3];
gout[n*48+35] = + s[3] - s[0];
gout[n*48+36] = - s[1];
gout[n*48+37] = - s[4];
gout[n*48+38] = + s[1] + s[4];
gout[n*48+39] = + s[4] - s[1];
gout[n*48+40] = - s[2];
gout[n*48+41] = - s[5];
gout[n*48+42] = + s[2] + s[5];
gout[n*48+43] = + s[5] - s[2];
gout[n*48+44] = 0;
gout[n*48+45] = 0;
gout[n*48+46] = 0;
gout[n*48+47] = 0;
...
if (gout_empty) {
gout[n*48+0] = - c[1]*s[24] + c[2]*s[15] + c[1]*s[21] - c[2]*s[12];
gout[n*48+1] = + c[1]*s[24] - c[2]*s[15] - c[1]*s[18] + c[2]*s[9];
gout[n*48+2] = - c[1]*s[21] + c[2]*s[12] + c[1]*s[18] - c[2]*s[9];
gout[n*48+3] = - c[1]*s[18] + c[2]*s[9] - c[1]*s[21] + c[2]*s[12] - c[1]*s[24] + c[2]*s[15];
gout[n*48+4] = - c[1]*s[25] + c[2]*s[16] + c[1]*s[22] - c[2]*s[13];
gout[n*48+5] = + c[1]*s[25] - c[2]*s[16] - c[1]*s[19] + c[2]*s[10];
gout[n*48+6] = - c[1]*s[22] + c[2]*s[13] + c[1]*s[19] - c[2]*s[10];
gout[n*48+7] = - c[1]*s[19] + c[2]*s[10] - c[1]*s[22] + c[2]*s[13] - c[1]*s[25] + c[2]*s[16];
gout[n*48+8] = - c[1]*s[26] + c[2]*s[17] + c[1]*s[23] - c[2]*s[14];
gout[n*48+9] = + c[1]*s[26] - c[2]*s[17] - c[1]*s[20] + c[2]*s[11];
gout[n*48+10] = - c[1]*s[23] + c[2]*s[14] + c[1]*s[20] - c[2]*s[11];
gout[n*48+11] = - c[1]*s[20] + c[2]*s[11] - c[1]*s[23] + c[2]*s[14] - c[1]*s[26] + c[2]*s[17];
gout[n*48+12] = 0;
gout[n*48+13] = 0;
gout[n*48+14] = 0;
gout[n*48+15] = 0;
gout[n*48+16] = - c[2]*s[6] + c[0]*s[24] + c[2]*s[3] - c[0]*s[21];
gout[n*48+17] = + c[2]*s[6] - c[0]*s[24] - c[2]*s[0] + c[0]*s[18];
gout[n*48+18] = - c[2]*s[3] + c[0]*s[21] + c[2]*s[0] - c[0]*s[18];
gout[n*48+19] = - c[2]*s[0] + c[0]*s[18] - c[2]*s[3] + c[0]*s[21] - c[2]*s[6] + c[0]*s[24];
gout[n*48+20] = - c[2]*s[7] + c[0]*s[25] + c[2]*s[4] - c[0]*s[22];
gout[n*48+21] = + c[2]*s[7] - c[0]*s[25] - c[2]*s[1] + c[0]*s[19];
gout[n*48+22] = - c[2]*s[4] + c[0]*s[22] + c[2]*s[1] - c[0]*s[19];
gout[n*48+23] = - c[2]*s[1] + c[0]*s[19] - c[2]*s[4] + c[0]*s[22] - c[2]*s[7] + c[0]*s[25];
gout[n*48+24] = - c[2]*s[8] + c[0]*s[26] + c[2]*s[5] - c[0]*s[23];
gout[n*48+25] = + c[2]*s[8] - c[0]*s[26] - c[2]*s[2] + c[0]*s[20];
gout[n*48+26] = - c[2]*s[5] + c[0]*s[23] + c[2]*s[2] - c[0]*s[20];
gout[n*48+27] = - c[2]*s[2] + c[0]*s[20] - c[2]*s[5] + c[0]*s[23] - c[2]*s[8] + c[0]*s[26];
gout[n*48+28] = 0;
gout[n*48+29] = 0;
gout[n*48+30] = 0;
gout[n*48+31] = 0;
gout[n*48+32] = - c[0]*s[15] + c[1]*s[6] + c[0]*s[12] - c[1]*s[3];
gout[n*48+33] = + c[0]*s[15] - c[1]*s[6] - c[0]*s[9] + c[1]*s[0];
gout[n*48+34] = - c[0]*s[12] + c[1]*s[3] + c[0]*s[9] - c[1]*s[0];
gout[n*48+35] = - c[0]*s[9] + c[1]*s[0] - c[0]*s[12] + c[1]*s[3] - c[0]*s[15] + c[1]*s[6];
gout[n*48+36] = - c[0]*s[16] + c[1]*s[7] + c[0]*s[13] - c[1]*s[4];
gout[n*48+37] = + c[0]*s[16] - c[1]*s[7] - c[0]*s[10] + c[1]*s[1];
gout[n*48+38] = - c[0]*s[13] + c[1]*s[4] + c[0]*s[10] - c[1]*s[1];
gout[n*48+39] = - c[0]*s[10] + c[1]*s[1] - c[0]*s[13] + c[1]*s[4] - c[0]*s[16] + c[1]*s[7];
gout[n*48+40] = - c[0]*s[17] + c[1]*s[8] + c[0]*s[14] - c[1]*s[5];
gout[n*48+41] = + c[0]*s[17] - c[1]*s[8] - c[0]*s[11] + c[1]*s[2];
gout[n*48+42] = - c[0]*s[14] + c[1]*s[5] + c[0]*s[11] - c[1]*s[2];
gout[n*48+43] = - c[0]*s[11] + c[1]*s[2] - c[0]*s[14] + c[1]*s[5] - c[0]*s[17] + c[1]*s[8];
gout[n*48+44] = 0;
gout[n*48+45] = 0;
gout[n*48+46] = 0;
gout[n*48+47] = 0;
