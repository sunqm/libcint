...
#include "c2f.h"
/* <NABLA i|OVLP |j> */
static void CINTgout1e_cint1e_ipovlp_sph(double *g, const unsigned int *ng,
...
static void CINTgout1e_cint1e_ipkin_sph(double *g, const unsigned int *ng,
double *gout, const unsigned int nf, const unsigned int *idx,
const double ai, const double aj,
const unsigned int *shls,
const int *atm, const int *bas, const double *env) {
...
/* <NABLA i|NUC |j> */
static void CINTgout1e_cint1e_ipnuc_sph(double *g, const unsigned int *ng,
double *gout, const unsigned int nf, const unsigned int *idx,
const double ai, const double aj,
const unsigned int *shls,
const int *atm, const int *bas, const double *env) {
...
/* <NABLA i|RINV |j> */
static void CINTgout1e_cint1e_iprinv_sph(double *g, const unsigned int *ng,
double *gout, const unsigned int nf, const unsigned int *idx,
const double ai, const double aj,
const unsigned int *shls,
const int *atm, const int *bas, const double *env) {
...
/* <i|RINV |j> */
static void CINTgout1e_cint1e_rinv_sph(double *g, const unsigned int *ng,
double *gout, const unsigned int nf, const unsigned int *idx,
const double ai, const double aj,
const unsigned int *shls,
const int *atm, const int *bas, const double *env) {
