...
CACHE_SIZE_T c##NAME##_sph_(double *out, FINT *shls, FINT *atm, FINT *natm, \
...
CACHE_SIZE_T c##NAME##_cart_(double *out, FINT *shls, FINT *atm, FINT *natm, \
                     FINT *bas, FINT *nbas, double *env, size_t optptr_as_integer8) { \
        CINTOpt **opt = (CINTOpt **)optptr_as_integer8; \
...
CACHE_SIZE_T c##NAME##_(double *out, FINT *shls, FINT *atm, FINT *natm, \
                FINT *bas, FINT *nbas, double *env, size_t optptr_as_integer8) { \
        CINTOpt **opt = (CINTOpt **)optptr_as_integer8; \
