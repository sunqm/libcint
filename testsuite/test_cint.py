...
def test_erf(name, omega, place):
    ...
    print(numpy.sort(op[:9**4]-op_lr[:9**4]-op_sr[:9**4]))
    print((op[:9**4]-op_lr[:9**4]-op_sr[:9**4]).argsort())
    print(op[3126], op_lr[3126], op_sr[3126])
    print(op[0], op_lr[0], op_sr[0])
    exit()
